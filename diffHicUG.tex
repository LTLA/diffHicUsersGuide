...
\setkeys{Gin}{width=0.5\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-068}
\end{center}
\setkeys{Gin}{width=0.8\textwidth}
...
\setkeys{Gin}{width=0.5\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-073}
\end{center}
\setkeys{Gin}{width=0.8\textwidth}
...
Finally, the offsets can be stored in the \code{InteractionSet} object as an additional matrix in \code{assays}.
This synchronises operations like subsetting on both the counts and offsets.

\begin{Schunk}
\begin{Sinput}
> assays(data)$offset <- nb.off
\end{Sinput}
\end{Schunk}
...
\setkeys{Gin}{width=0.8\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-082}
\end{center}
\setkeys{Gin}{width=0.8\textwidth}
...
Manual setting of \code{y\$offset} is shown below only for demonstration purposes.)
...
\setkeys{Gin}{width=0.6\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-087}
\end{center}
\setkeys{Gin}{width=0.8\textwidth}
...
\begin{center}
\includegraphics{plots-ug/ug-116}
\includegraphics{plots-ug/ug-117}
\end{center}
\setkeys{Gin}{width=0.8\textwidth}
...
\setkeys{Gin}{width=0.48\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-123}
\includegraphics{plots-ug/ug-124}
\end{center}
\setkeys{Gin}{width=0.8\textwidth}
...
\setkeys{Gin}{width=0.8\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-130}
\\
...
\setkeys{Gin}{width=0.6\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-144}
\end{center}
\setkeys{Gin}{width=0.8\textwidth}
...
\setkeys{Gin}{width=0.6\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-146}
\end{center}
\setkeys{Gin}{width=0.8\textwidth}
...
\setkeys{Gin}{width=0.8\textwidth}
\begin{center}
\includegraphics{plots-ug/ug-155}
\\
\includegraphics{plots-ug/ug-156}
\end{center}
\setkeys{Gin}{width=0.8\textwidth}
...
loaded via a namespace (and not attached):
 [1] splines_3.4.0            zlibbioc_1.21.0          GenomicAlignments_1.11.3
 [4] statmod_1.4.27           lattice_0.20-34          tools_3.4.0             
