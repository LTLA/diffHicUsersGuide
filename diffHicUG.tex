...
\textit{Last compiled:} 22 September 2017
\end{abstract}

\packageVersion{diffHic 1.9.6}
...
\hlkwd{hist}\hlstd{(diags}\hlopt{$}\hlstd{length[diags}\hlopt{$}\hlstd{length} \hlopt{<} \hlnum{1000}\hlstd{],} \hlkwc{ylab}\hlstd{=}\hlstr{"Frequency"}\hlstd{,} \hlkwc{xlab}\hlstd{=}\hlstr{"Spacing (bp)"}\hlstd{)}
\end{alltt}
...
\definecolor{shadecolor}{rgb}{0.941, 0.941, 0.941}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{to.keep} \hlkwb{<-} \hlkwd{as.matrix}\hlstd{(cm1)} \hlopt{+} \hlkwd{as.matrix}\hlstd{(cm2)} \hlopt{>=} \hlnum{10}
\hlstd{iset1} \hlkwb{<-} \hlkwd{deflate}\hlstd{(cm1,} \hlkwc{extract}\hlstd{=to.keep)}
\hlstd{iset2} \hlkwb{<-} \hlkwd{deflate}\hlstd{(cm2,} \hlkwc{extract}\hlstd{=to.keep)}
\hlstd{data.com} \hlkwb{<-} \hlkwd{cbind}\hlstd{(iset1, iset2)}
\hlkwd{interactions}\hlstd{(data.com)} \hlkwb{<-} \hlkwd{as}\hlstd{(}\hlkwd{interactions}\hlstd{(data.com),}
                             \hlstr{"ReverseStrictGInteractions"}\hlstd{)}
\hlstd{data.com}\hlopt{$}\hlstd{totals} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlkwd{sum}\hlstd{(}\hlkwd{as.matrix}\hlstd{(cm1)),} \hlkwd{sum}\hlstd{(}\hlkwd{as.matrix}\hlstd{(cm2)))}
\end{alltt}
\end{kframe}
\end{knitrout}
