...
It is easily extended to datasets involving more than two samples, by simply considering additional objects when constructing \Robject{tokeep} and \Robject{data}.
